...
| :--- | ---: | :--- |
| **[coollabsio/coolify](https://github.com/coollabsio/coolify)** | 62,252 | [#4288 Fix for the Self-XSS](https://github.com/coollabsio/coolify/pull/4288) |
| **[GoogleCloudPlatform/python-docs-samples](https://github.com/GoogleCloudPlatform/python-docs-samples)** | 8,137 | [#10341 FIx for arbitrary javascript injection](https://github.com/GoogleCloudPlatform/python-docs-samples/pull/10341) |
...
| **[mozmeao/springfield](https://github.com/mozmeao/springfield)** | 17 | [#1472 Reject SVG uploads when sanitized output exceeds max size](https://github.com/mozmeao/springfield/pull/1472) |
